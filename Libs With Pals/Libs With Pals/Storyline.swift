...
class Storyline {
    ...
    let groceryBlanks = ["name", "noun", "gender", "name", "gender", "noun", "noun - article of clothing", "gender", "adjective", "name", "noun - emotion", "name", "name", "gender", "gender", "gender", "noun", "name", "noun - plural", "name", "gender", "noun - place", "gender", "adverb"]
