...
class Storyline {
    ...
    let groceryBlanks = ["name", "noun", "possessive-pronoun", "name", "possesive-pronoun", "noun", "noun - article of clothing", "pronoun", "adjective", "name", "noun - emotion", "name", "name", "pronoun", "pronoun", "pronoun", "noun", "name", "noun - plural", "name", "pronoun", "noun - place", "pronoun", "adverb"]
